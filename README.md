...
tstf/0.0.10 darwin-x64 node-v11.10.0
$ tstf --help [COMMAND]
USAGE
  $ tstf COMMAND
...
...
_See code: [dist/node/commands/genIndex.ts](https://github.com/joonhocho/tstf/blob/v0.0.10/dist/node/commands/genIndex.ts)_
...
_See code: [dist/node/commands/relToAlias.ts](https://github.com/joonhocho/tstf/blob/v0.0.10/dist/node/commands/relToAlias.ts)_
<!-- commandsstop -->
